const STOCK_APP_CACHE = 'seniorflow-stock-app-20260630-02';
const STOCK_APP_ASSETS = [
  './stock-app.html',
  './stock-app.js?v=seniorflow-react-20260630-stock-app-02',
  './firebase-config.js?v=seniorflow-react-20260630-stock-app-02',
