    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-28 md:pb-8 print:bg-white print:pb-0">
      ...
      {modalActivo === 'imprimir_catalogo' && catalogoAImprimir && (
        <div className="fixed inset-0 bg-gray-100 z-50 overflow-y-auto flex justify-center py-10 print:p-0 print:bg-white custom-scrollbar">
          ...
          <div className="print-a4-sheet box-border bg-white w-full max-w-[210mm] min-h-[297mm] shadow-2xl print:shadow-none p-8 sm:p-12 text-black font-sans">
            ...
            <div className="space-y-6">
              {catalogoAImprimir.grupos.map((grupo) => (
                <div key={grupo.categoria}>
                  <div className="bg-slate-800 text-white px-4 py-2 rounded-lg mb-3 print-no-break">
            ...
            <div className="mt-8 border-t border-gray-300 pt-4 text-center print-no-break">
      ...
      {modalActivo === 'imprimir_presupuesto' && presupuestoAImprimir && (
        <div className="fixed inset-0 bg-gray-100 z-50 overflow-y-auto flex justify-center py-10 print:p-0 print:bg-white custom-scrollbar">
          ...
          <div className="print-a4-sheet box-border bg-white w-full max-w-[210mm] min-h-[297mm] shadow-2xl print:shadow-none p-10 sm:p-16 text-black font-sans relative">
            ...
            <table className="w-full text-sm mb-8 border-collapse table-fixed">
              <thead className="bg-gray-800 text-white font-bold uppercase text-[10px] tracking-wider">
                <tr>
                  <th className="py-2 px-2 text-left w-[9%]">Cód.</th>
                  {incluirImagenesPdf && <th className="py-2 px-2 text-center w-[12%]">Imagen</th>}
                  <th className="py-2 px-2 text-left">Descripción del Producto/Servicio</th>
                  <th className="py-2 px-2 text-center w-[8%]">Cant.</th>
                  <th className="py-2 px-2 text-center w-[8%]">Unid.</th>
                  <th className="py-2 px-2 text-right w-[11%]">Precio U.</th>
                  {mostrarDescuentoItemEnPdf && <th className="py-2 px-2 text-center w-[7%]">Desc.%</th>}
                  <th className="py-2 px-2 text-right w-[13%]">Subtotal</th>
                </tr>
              </thead>
                ...
                {presupuestoAImprimir.items.map((item, i) => {
                  ...
                  return (
                    <tr key={i} className="border-b border-gray-200 print-no-break">
                      <td className="py-2 px-2 text-gray-500 text-[11px] align-top break-words">{item.codigo || '-'}</td>
                      {incluirImagenesPdf && (
                      ...
                      <td className="py-2 px-2 font-bold text-[11px] whitespace-normal break-words align-top leading-snug">{item.descripcion}</td>
                      <td className="py-2 px-2 text-center font-bold text-[11px] align-top">{item.cantidad}</td>
                      <td className="py-2 px-2 text-center text-[11px] uppercase align-top">{item.unidad}</td>
                      <td className="py-2 px-2 text-right text-[11px] align-top">{formatearDinero(item.precio)}</td>
                      {mostrarDescuentoItemEnPdf && <td className="py-2 px-2 text-center font-bold text-[11px] align-top">{parseNumeroPresupuesto(item?.descuento) > 0 ? `${parseNumeroPresupuesto(item?.descuento)}%` : '-'}</td>}
                      <td className="py-2 px-2 text-right font-black text-[11px] align-top">{formatearDinero(calcularTotalItemPresupuesto(item))}</td>
                    </tr>
                  );
                })}
              </tbody>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-6 mt-8 print-no-break">
              ...
              <div className="w-full sm:w-1/2 flex sm:justify-end">
                <div className="bg-gray-100 p-6 rounded-xl border-2 border-gray-800 w-full max-w-[360px] text-right">
