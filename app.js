...
async function ensureAnonymousSession() {
  ...
  try {
    ...
    console.error(error);
    throw new Error("No se pudo conectar con Firebase para iniciar sesión. Revisá que la autenticación anónima esté activada y que GitHub Pages esté autorizado.");
  }
}
