    ...
    <div class="simple-item budget-row ${state.selectedBudgetId === budget.id ? "active" : ""}">
      <button class="budget-btn-main" data-id="${budget.id}" type="button">
        <div class="record-head">
          ...
          <span class="record-amount">${currency(budget.total)}</span>
        </div>
        <div class="top-badges">
...
function createBudgetItemRow(item = {}) {
  ...
  row.innerHTML = `
    <div class="budget-item-top full">
      <div>
    ...
    <label class="budget-source-field">
      <span>Origen</span>
      <select name="source">
    ...
    <label class="${source === "stock" ? "" : "hidden"} budget-stock-wrap full">
    ...
    <div class="budget-item-fields full">
      <label>
        <span>Cantidad</span>
