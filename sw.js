const CACHE_NAME = 'seniorflow-shared-20260807191500';
const ASSETS = [
  './',
  './index.html',
  './stock-app.html',
  './stock-app.js?v=seniorflow-shared-20260807191500',
  './app.js?v=seniorflow-shared-20260807191500',
  './firebase-config.js?v=seniorflow-react-20260715-pdf-pagination-06',
  './manifest.json',
  './manifest-stock-app.json',
  './sw-stock-app.js?v=seniorflow-shared-20260807191500',
